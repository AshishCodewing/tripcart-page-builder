  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        ...
        variant === "border" && "not-last:border-b border-border",
...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDownIcon data-slot="accordion-trigger-icon" className="pointer-events-none shrink-0 transition-transform duration-200 text-muted-foreground group-aria-expanded/accordion-trigger:rotate-180 group-aria-expanded/accordion-trigger:text-primary" />
      </AccordionPrimitive.Trigger>
...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-(--accordion-panel-height) px-5 pb-4 pt-0 text-base leading-6 text-muted-foreground data-ending-style:h-0 data-starting-style:h-0",
          className,
        )}
      >
        {children}
